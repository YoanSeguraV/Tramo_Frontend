              ...
              <table className="table align-items-center mb-0">
                <thead>
                  <tr className="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                    <th className="cabecera_info" style={{fontSize:"14px"}}>CONDUCTOR</th>
                    <th className="cabecera_info" style={{fontSize:"14px"}}>PASAJERO</th>
                    <th className="cabecera_info" style={{fontSize:"14px"}}>CANTIDAD </th>
                    <th className="cabecera_info" style={{fontSize:"14px"}}>ESPECIFICACIONES </th>
                    <th className="cabecera_info" style={{fontSize:"14px"}}>VALOR</th>
                    <th className="cabecera_info" style={{fontSize:"14px"}}>MANIFIESTO</th>
                  </tr>
                </thead>
                <tbody>
                  <HistorialCards />
